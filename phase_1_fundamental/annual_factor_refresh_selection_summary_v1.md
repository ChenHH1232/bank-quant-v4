...
- `improve__annual_delta__bank_indicator__capital_adequacy_ratio` | layer=`improvement_layer`
- `improve__snapshot_delta__derived__investment_income_to_operating_revenue` | layer=`improvement_layer`
- `indicator__eps` | layer=`base_core`
- `indicator__roe` | layer=`base_core`
...
- `derived__log_total_assets` | layer=`base_core`
- `improve__annual_delta__bank_indicator__Nonperforming_loan_rate` | layer=`improvement_layer`
- `improve__snapshot_delta__indicator__inc_net_profit_to_shareholders_annual` | layer=`improvement_layer`
...
- `bank_indicator__non_performing_loan_provision_coverage` | layer=`base_core`
- `derived__log_total_assets` | layer=`base_core`
- `improve__season_yoy_delta__derived__staff_cash_to_operating_revenue` | layer=`improvement_layer`
- `improve__snapshot_delta__indicator__inc_net_profit_to_shareholders_annual` | layer=`improvement_layer`
...
- `improve__snapshot_delta__indicator__eps` | layer=`improvement_layer`
...
- `improve__annual_delta__bank_indicator__Nonperforming_loan_rate` | kept_folds=`2/5` | layer=`improvement_layer`
- `improve__snapshot_delta__derived__investment_income_to_operating_revenue` | kept_folds=`2/5` | layer=`improvement_layer`
- `improve__snapshot_delta__indicator__inc_net_profit_to_shareholders_annual` | kept_folds=`2/5` | layer=`improvement_layer`
...
- `improve__annual_delta__bank_indicator__capital_adequacy_ratio` | kept_folds=`1/5` | layer=`improvement_layer`
- `improve__season_yoy_delta__derived__staff_cash_to_operating_revenue` | kept_folds=`1/5` | layer=`improvement_layer`