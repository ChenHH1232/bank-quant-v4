...
def initialize(context):
    ...
    g.group_count = 5
    g.hold_bucket = 5
    # manual pure-fundamental style switch:
    # - 'balanced' = base_core_6 + top_08
    # - 'core_level' = base_core_6 - indicator__eps + core_level_capital_adequacy_ratio
    g.strategy_line = 'benchmark'  # 'primary' or 'benchmark'
    g.manual_style_mode = 'balanced'  # 'balanced' or 'core_level'
    g.debug = True
