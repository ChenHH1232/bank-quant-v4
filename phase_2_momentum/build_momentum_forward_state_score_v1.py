...
OUT_SCORE_PATH = SCRIPT_DIR / "momentum_forward_state_score_v1.csv"
OUT_SUMMARY_PATH = SCRIPT_DIR / "momentum_forward_state_score_v1.md"
...
def add_state_score(proxy_df: pd.DataFrame) -> pd.DataFrame:
    ...
    out["state_score_v1"] = sum(parts) / float(len(parts))
    return out
...
def main() -> None:
    ...
    eval_row = evaluate_score(score_df, "state_score_v1")
