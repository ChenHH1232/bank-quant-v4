...
RESULTS_PATH = SCRIPT_DIR / "momentum_monthly_rolling_validation_v2_results.csv"
SUMMARY_PATH = SCRIPT_DIR / "momentum_monthly_rolling_validation_v2.md"
...
CANDIDATE_SPECS = [
    {"factor_name": "mom_6_1", "components": [("mom_6_1", 1.0)], "priority_rank": 1},
    {"factor_name": "combo_631_midheavy", "components": [("mom_3_1", 0.1), ("mom_6_1", 0.6), ("mom_12_1", 0.3)], "priority_rank": 2},
    {"factor_name": "combo_631_balanced", "components": [("mom_3_1", 0.2), ("mom_6_1", 0.5), ("mom_12_1", 0.3)], "priority_rank": 3},
    {"factor_name": "mom_3_1", "components": [("mom_3_1", 1.0)], "priority_rank": 4},
    {"factor_name": "mom_12_1", "components": [("mom_12_1", 1.0)], "priority_rank": 5},
]
...
def build_folds(dates: list[pd.Timestamp]) -> list[dict[str, object]]:
    ...
    for start_idx in range(0, len(dates) - span + 1):
        ...
        folds.append(
            {
                "fold_id": f"mom_mfold_{len(folds) + 1:03d}",
...
def build_result_rows(panel_df: pd.DataFrame, folds: list[dict[str, object]]) -> list[dict[str, object]]:
    ...
    for fold in folds:
        ...
        selected_name, selected_validation_metrics, candidate_scores = select_candidate(scored_df, candidate_meta, validation_mask)
