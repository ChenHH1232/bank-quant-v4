...
def initialize(context):
    ...
    # This version is intentionally closer to a classic 6-1 momentum line.
    # We keep enough history for 6-1 with a one-month skip and some buffer.
    g.max_price_history_count = 170
    ...
    # Research-driven annual plan:
    # - keep the same annual refresh schedule as v1
    # - switch the active alpha to pure 6-1 momentum
    # This isolates factor-choice changes from rebalance-frequency changes.
    g.annual_factor_plan = [
        {"effective_date": "2021-05-31", "factor_name": "mom_6_1", "components": [("mom_6_1", 1.0)], "source": "offline_momentum_6_1_mainline"},
        {"effective_date": "2022-05-05", "factor_name": "mom_6_1", "components": [("mom_6_1", 1.0)], "source": "offline_momentum_6_1_mainline"},
        {"effective_date": "2023-05-04", "factor_name": "mom_6_1", "components": [("mom_6_1", 1.0)], "source": "offline_momentum_6_1_mainline"},
        {"effective_date": "2024-05-06", "factor_name": "mom_6_1", "components": [("mom_6_1", 1.0)], "source": "offline_momentum_6_1_mainline"},
        {"effective_date": "2025-05-06", "factor_name": "mom_6_1", "components": [("mom_6_1", 1.0)], "source": "offline_momentum_6_1_mainline"},
        {"effective_date": "2026-05-06", "factor_name": "mom_6_1", "components": [("mom_6_1", 1.0)], "source": "offline_momentum_6_1_mainline"},
    ]
            ...
            % str(
                {
                    ...
                    "selection_mode": "offline_annual_factor_plan_raw_6_1",
